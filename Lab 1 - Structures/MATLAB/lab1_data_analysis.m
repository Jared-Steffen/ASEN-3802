...
hold on
grid on; grid minor
scatter(case_1_applied_force, case_1_load_sensor_1,"LineWidth", 1.2)
scatter(case_2_applied_force, case_2_load_sensor_1,"LineWidth", 1.2)
scatter(case_3_applied_force, case_3_load_sensor_1,"LineWidth", 1.2)
...
legend('Case 1', 'Case 2', 'Case 3','Location','northwest')
hold off
print('all cases internal','-r300','-dpng')
...
legend('Case 1', 'Case 2', 'Case 3','Location','northwest')
hold off
print('all cases displacement','-r300','-dpng')
